...
public class WaylandFFM implements WaylandAPI {
  ...
  public long wlr_fixes_create(long display,int value) { try { long _ret_value_ = (long)wlr_fixes_create.invokeExact(display,value);return _ret_value_; } catch (Throwable t) { JFLog.log(t);  return -1;} }
