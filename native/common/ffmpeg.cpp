...
extern "C" {
  ...
  JNIEXPORT jshort* (*_audioDecoderDecode)(FFContext* ctx, jbyte* data, jint offset, jint length) = &audioDecoderDecode;
  ...
  JNIEXPORT jbyte* (*_audioEncoderEncode)(FFContext* ctx, jshort* samples, jint offset, jint length) = &audioEncoderEncode;
  ...
  JNIEXPORT jint* (*_videoDecoderDecode)(FFContext* ctx, jbyte* data, jint offset, jint length) = &videoDecoderDecode;
  ...
  JNIEXPORT jbyte* (*_videoEncoderEncode)(FFContext* ctx, jint* px, jint offset, jint length) = &videoEncoderEncode;
}
