...
------------------------
This version of JavaForce is compatible with native loaders/library since 114.0

JavaForce Ant tasks:
--------------------
get-ffmpeg-win64-bin : Download ffmpeg libraries for Win64 (ant may fail to extract zip)
get-ffmpeg-win64-src : Download ffmpeg sources for Win64 (to build native loader) (ant may fail to extract zip)
  ffmpeg-win64 versions 7.1.0, 8.1.1 are available (you must edit versions.properties)
...
Maven
-----
JavaForce is available in Maven Central : https://repo1.maven.org/maven2/io/github/pquiring/javaforce/
Ant tasks are used to download dependancies and upload projects to Maven Central.
The mvn tool is not required (way too complex and has issues with native code).
